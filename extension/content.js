...
browser.storage.local.set({ mouse: true }).then(() => {})
browser.storage.local.set({ microphone: true }).then(() => {})
browser.storage.local.set({ keyboard: true }).then(() => {})
browser.storage.local.set({ camera: true }).then(() => {})
...
browser.storage.local.get(['mouse']).then((result) => {
...
browser.storage.local.get(['keyboard']).then((result) => {
...
browser.storage.local.get(['microphone']).then((result) => {
