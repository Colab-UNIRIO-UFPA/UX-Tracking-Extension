<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		//}else{
			$txt = "<rawtrace type=\"".$metadata->type."\" image=\"".$data->imageName."\" time=\"".$metadata->time."\" class=\"".$data->Class."\" id=\"".$data->Id."\" mouseClass=\"".$data->mouseClass."\" mouseId=\"".$data->mouseId."\" x=\"".$data->X."\" y=\"".$data->Y."\" voice=\"".$data->spoken."\" keys=\"".$data->Typed."\" scroll=\"".$metadata->scroll."\" height=\"".$metadata->height."\" url=\"".$metadata->url."\" />";
